...
public class JGitScmProvider extends JGitScmProviderBefore77 {

  private final GitIgnoreCommand gitIgnoreCommand;

  public JGitScmProvider(GitBlameCommand gitBlameCommand, AnalysisWarningsWrapper analysisWarnings, GitIgnoreCommand gitIgnoreCommand) {
